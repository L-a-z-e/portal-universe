...
import type { ToastProps, ToastItem, ToastContainerProps } from '@portal/design-core';
import { cn, toastBase, toastVariants } from '@portal/design-core';
  ...
  (
    ...
    return (
      <div
        ...
        {...props}
      >
        <div className={cn('shrink-0', toastVariants[variant].icon)}>{icons[variant]}</div>
