      ...
      <div className="flex items-center justify-between">
        ...
        {canCancel && (
          <button
            ...
            disabled={cancelling}
            className="px-4 py-2 text-status-error border border-status-error rounded-lg hover:bg-status-error hover:text-white transition-colors disabled:opacity-50"
          >
