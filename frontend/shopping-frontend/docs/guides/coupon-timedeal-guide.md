...
- [Queue API](../../services/shopping-service/docs/api/queue-api.md) - 대기열 API
- [Coupon API](../../services/shopping-service/docs/api/coupon-api.md) - 쿠폰 API
- [TimeDeal API](../../services/shopping-service/docs/api/timedeal-api.md) - 타임딜 API
- [ADR-002](../../services/shopping-service/docs/adr/ADR-002-queue-system-design.md) - 대기열 시스템 설계
