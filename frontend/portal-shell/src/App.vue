...
<template>
  <div class="min-h-screen flex flex-col bg-bg-page text-text-body transition-colors duration-normal">
    <!-- Header - Linear style sticky header -->
    <header class="bg-bg-card/80 backdrop-blur-md border-b border-border-default sticky top-0 z-50">
      <div class="max-w-7xl mx-auto px-4 py-3">
        <div class="flex items-center justify-between">
          ...
          <router-link to="/" class="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <span class="text-lg font-semibold hidden sm:block text-text-heading">
              Portal Universe
            </span>
          </router-link>
          ...
          <nav class="flex items-center gap-1">
            <router-link
                to="/"
                class="px-3 py-2 rounded-md text-text-body hover:text-text-heading hover:bg-bg-elevated font-medium transition-all"
                active-class="!text-text-heading !bg-bg-elevated"
            >
              Home
            </router-link>
            <router-link
          ...
          <div class="flex items-center gap-3">
            ...
            <template v-if="authStore.isAuthenticated">
              <div class="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-md bg-bg-elevated border border-border-default">
                <span class="text-sm font-medium text-text-heading">{{ authStore.displayName }}</span>
    ...
    <footer class="bg-bg-card border-t border-border-default py-6 mt-auto">
