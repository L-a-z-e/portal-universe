const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BoardListPage-CSQ_FK8H.js","assets/__federation_fn_import-BuQQgUXV.js","assets/jsx-runtime-XI9uIe3W.js","assets/api-Df7DtIvT.js","assets/boardStore-CbPfJ9jS.js","assets/react-wF4C62jk.js","assets/BoardPage-DBeGQj_C.js","assets/agentStore-CqzecZph.js","assets/AgentsPage-RC6p4tdo.js","assets/providerStore-ZOpK-RXU.js","assets/ProvidersPage-m_y4fcy_.js","assets/Layout-DUa9cltt.js"])))=>i.map(i=>d[i]);
import { r as requireReact, g as getDefaultExportFromCjs } from './index-Bli_BMNH.js';
import { r as requireReactDom } from './index-DPrQWDGo.js';
...
const scriptRel = 'modulepreload';const assetsURL = function(dep) { return "http://localhost:30003/"+dep };const seen = {};const __vitePreload = function preload(baseModule, deps, importerUrl) {
...
const remotesMap = {
'portal':{url:'http://localhost:30000/assets/shellEntry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'undefined':{get:()=>get(new URL('__federation_shared_react-DH2e58zs.js', import.meta.url).href), loaded:1}},'react-dom':{'undefined':{get:()=>get(new URL('__federation_shared_react-dom-Ba0vVa9o.js', import.meta.url).href), loaded:1}},'react-router-dom':{'undefined':{get:()=>get(new URL('__federation_shared_react-router-dom-DsVBnfxz.js', import.meta.url).href), loaded:1}}
...
const __vite_import_meta_env__ = {"BASE_URL": "http://localhost:30003", "DEV": false, "MODE": "production", "PROD": true, "SSR": false, "VITE_API_BASE_URL": "/api", "VITE_BASE_URL": "http://localhost:30003", "VITE_PORTAL_SHELL_REMOTE_URL": "http://localhost:30000/assets/shellEntry.js"};
  ...
  devtools(
    (set, get) => ({
      ...
      syncFromPortal: async () => {
        ...
        try {
          const portalStoresModule = await __federation_method_getRemote("portal" , "./stores").then(module=>__federation_method_wrapDefault(module, true));
          const actualModule = portalStoresModule.default || portalStoresModule;
...
const {useEffect: useEffect$3,useState: useState$1} = await importShared('react');

const {Navigate: Navigate$1,useLocation: useLocation$1} = await importShared('react-router-dom');
const RequireAuth = ({
  children,
  redirectTo = "/"
}) => {
  ...
  if (!isInitialized || loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[400px] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 border-4 border-prism-500 border-t-transparent rounded-full animate-spin" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-text-meta text-sm", children: "Checking authentication..." })
    ] }) });
  }
  if (!isAuthenticated) {
    console.warn("[RequireAuth] User not authenticated, redirecting to:", redirectTo);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate$1, { to: redirectTo, state: { from: location }, replace: true });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
};

const {Suspense,lazy,useEffect: useEffect$2,useRef} = await importShared('react');

const {createBrowserRouter,createMemoryRouter,RouterProvider,Navigate,useLocation} = await importShared('react-router-dom');

const BoardListPage = lazy(() => __vitePreload(() => import('./BoardListPage-CSQ_FK8H.js'),true              ?__vite__mapDeps([0,1,2,3,4,5]):void 0));
const BoardPage = lazy(() => __vitePreload(() => import('./BoardPage-DBeGQj_C.js'),true              ?__vite__mapDeps([6,1,2,3,5,7,4]):void 0));
const AgentsPage = lazy(() => __vitePreload(() => import('./AgentsPage-RC6p4tdo.js'),true              ?__vite__mapDeps([8,1,2,3,7,5,9]):void 0));
const ProvidersPage = lazy(() => __vitePreload(() => import('./ProvidersPage-m_y4fcy_.js'),true              ?__vite__mapDeps([10,1,2,3,9,5]):void 0));
const AppLayout = lazy(() => __vitePreload(() => import('./Layout-DUa9cltt.js'),true              ?__vite__mapDeps([11,1,2]):void 0));
const PageLoader = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[400px] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-text-meta text-sm", children: "Loading..." })
] }) });
...
const LayoutWithSync = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(NavigationSync, {}),
  /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, {}) })
] });
const routes = [
  {
    path: "/",
    element: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutWithSync, {}),
    children: [
      {
        index: true,
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/boards", replace: true })
      },
      {
        path: "boards",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(BoardListPage, {}) }) })
      },
      {
        path: "boards/:boardId",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(BoardPage, {}) }) })
      },
      {
        path: "agents",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(AgentsPage, {}) }) })
      },
      {
        path: "providers",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProvidersPage, {}) }) })
      },
      {
...
const PrismRouter = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router: routerRef.current });
};

const {useState,useEffect: useEffect$1,useCallback} = await importShared('react');
...
function usePortalTheme() {
  ...
  useEffect$1(() => {
    ...
    __federation_method_getRemote("portal" , "./stores").then(module=>__federation_method_wrapDefault(module, true)).then((module) => {
      const actualModule = module.default || module;
      const themeAdapter = actualModule.themeAdapter;
      if (!themeAdapter) {
...
function App({
  ...
  const isDark = isEmbedded && portalTheme.isConnected ? portalTheme.isDark : theme === "dark";
  const updateDataTheme = (isDark2) => {
    const themeValue = isDark2 ? "dark" : "light";
  ...
  useEffect(() => {
    ...
    console.log(`[Prism] Theme applied: ${isDark ? "dark" : "light"} (source: ${isEmbedded && portalTheme.isConnected ? "Portal adapter" : "props"})`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-bg-page", children: [
    !isEmbedded && /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-bg-card border-b border-border-default sticky top-0 z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 hover:opacity-80 transition-opacity cursor-pointer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-gradient-to-br from-prism-500 to-prism-700 flex items-center justify-center shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-lg", children: "P" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-text-heading", children: "Prism" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-1 bg-status-success-bg text-status-success text-sm font-medium rounded-full border border-status-success/20", children: "Standalone" })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: isEmbedded ? "py-4" : "py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PrismRouter,
      {
        isEmbedded,
        initialPath,
    ...
    !isEmbedded && /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-bg-card border-t border-border-default mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 py-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-meta", children: "© 2025 Portal Universe Prism. All rights reserved." }) }) })
  ] });
}

export { App as A, ReactDOM as R, navigateTo as n, resetRouter as r, setAppActive as s };
