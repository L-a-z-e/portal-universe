...
function Modal({ isOpen, onClose, title, children, size = "md" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `bg-white rounded-xl shadow-xl w-full ${sizeClasses$1[size]} mx-4 animate-in fade-in zoom-in-95 duration-200`, children: [
...
const Input = forwardRef$2(
  ({ label, error, helperText, className = "", id, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
      ...
      helperText && !error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-gray-500", children: helperText })
    ] });
  }
);
...
class ApiService {
  ...
  // Provider APIs
  async getProviders() {
    return this.request("get", "/prism/providers");
  }
  async getProvider(id) {
    return this.request("get", `/prism/providers/${id}`);
  }
  async createProvider(data) {
    return this.request("post", "/prism/providers", data);
  }
  async deleteProvider(id) {
    return this.request("delete", `/prism/providers/${id}`);
  }
  // Agent APIs
  async getAgents() {
    return this.request("get", "/prism/agents");
  }
  async getAgent(id) {
    return this.request("get", `/prism/agents/${id}`);
  }
  async createAgent(data) {
    return this.request("post", "/prism/agents", data);
  }
  async updateAgent(id, data) {
    return this.request("put", `/prism/agents/${id}`, data);
  }
  async deleteAgent(id) {
    return this.request("delete", `/prism/agents/${id}`);
  }
  // Board APIs
  async getBoards() {
    return this.request("get", "/prism/boards");
  }
  async getBoard(id) {
    return this.request("get", `/prism/boards/${id}`);
  }
  async createBoard(data) {
    return this.request("post", "/prism/boards", data);
  }
  async updateBoard(id, data) {
    return this.request("put", `/prism/boards/${id}`, data);
  }
  async deleteBoard(id) {
    return this.request("delete", `/prism/boards/${id}`);
  }
  // Task APIs
  async getTasks(boardId) {
    return this.request("get", `/prism/boards/${boardId}/tasks`);
  }
  async getTask(id) {
    return this.request("get", `/prism/tasks/${id}`);
  }
  async createTask(data) {
    const { boardId, ...taskData } = data;
    return this.request("post", `/prism/boards/${boardId}/tasks`, taskData);
  }
  async updateTask(id, data) {
    return this.request("put", `/prism/tasks/${id}`, data);
  }
  async moveTask(id, data) {
    return this.request("patch", `/prism/tasks/${id}/position`, data);
  }
  async assignAgent(taskId, agentId) {
    return this.request("put", `/prism/tasks/${taskId}`, { agentId });
  }
  async deleteTask(id) {
    return this.request("delete", `/prism/tasks/${id}`);
  }
  // Execution APIs
  async executeTask(taskId) {
    return this.request("post", `/prism/tasks/${taskId}/execute`);
  }
  async getExecutions(taskId) {
    return this.request("get", `/prism/tasks/${taskId}/executions`);
  }
  async getExecution(id) {
    return this.request("get", `/prism/executions/${id}`);
  }
}
const api = new ApiService();

export { Button as B, Input as I, Modal as M, Select as S, Textarea as T, api as a };
