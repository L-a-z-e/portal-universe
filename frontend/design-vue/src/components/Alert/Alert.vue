...
import { alertBase, alertVariants } from '@portal/design-core';
...
const containerClasses = computed(() => [
  alertBase,
  alertVariants[props.variant].container,
...
<template>
  ...
  >
    ...
    >
      <!-- Icon -->
      <div v-if="showIcon" :class="['flex-shrink-0', alertVariants[variant].icon]">
        <slot name="icon">
          <!-- Info icon -->
