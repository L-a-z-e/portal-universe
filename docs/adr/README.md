...
| ADR-033 | [Polyglot 서비스 관찰성 통일 전략](./ADR-033-polyglot-observability-strategy.md)                   | Proposed | 2026-02-11 |
| ADR-034 | [비Java 서비스 CI/CD 파이프라인 통합](./ADR-034-non-java-cicd-integration.md)                 | Proposed | 2026-02-11 |
| ADR-035 | [Polyglot 서비스 인증 표준화](./ADR-035-polyglot-authentication-standardization.md)             | Proposed | 2026-02-11 |
