...
| 문서 | 설명 | 경로 |
|------|------|------|
| Spring Cloud Gateway | Route, Predicate, Filter 상세 | <!-- TODO: verify link - moved to centralized docs --> |
| Circuit Breaker | Resilience4j 상태 전이, 설정 | <!-- TODO: verify link - moved to centralized docs --> |
| JWT Validation | JWT 검증, 접근 제어 상세 | <!-- TODO: verify link - moved to centralized docs --> |
| Architecture Overview | API Gateway 시스템 개요 | [API Gateway Architecture](../../architecture/) |
| Routing Specification | 라우팅 규칙 명세 | [API Reference](../../api/) |
