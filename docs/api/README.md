...
| Payment Service | [payment-service/](./payment-service/) | 결제 Intent 관리, 결제 처리/취소/환불 | 1 |
| Shopping Service | [shopping-service/](./shopping-service/) | 장바구니, 주문, 배송 (Buyer) | 10 |
