...
| 문서 ID | 제목 | 상태 | 작성일 | 설명 |
|---------|------|------|--------|------|
| notification-service-architecture-system-overview | [Notification Service 시스템 아키텍처](./system-overview.md) | current | 2026-01-18 | 시스템 전체 구조 및 Kafka Consumer 기반 이벤트 처리 아키텍처 |
