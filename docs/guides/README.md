...
> Portal Universe 프로젝트의 개발, 배포, 운영 가이드 모음입니다.
...
- [신규 서비스 추가 가이드](./development/new-service-guide.md) - Backend + Frontend 서비스 추가
...
### [배포 가이드](./deployment/)
Docker, Kubernetes, CI/CD 등 배포 관련 가이드

### [운영 가이드](./operations/)
모니터링, 로깅, 장애 대응 등 운영 관련 가이드
