...
시나리오 문서는 **"누가, 언제, 어떻게, 왜"**를 정의하여 기능 구현의 맥락을 명확히 합니다.

- **Actor**: 누가 이 기능을 사용하는가?
- **Trigger**: 언제 이 기능이 실행되는가?
- **Flow**: 어떻게 동작하는가?
- **Goal**: 왜 이 기능이 필요한가?
...
시나리오 문서 작성 방법은 [docs_template/guide/scenarios/how-to-write.md](../../docs_template/guide/scenarios/how-to-write.md)를 참조하세요.

## 관련 문서

- [ADR 목록](../adr/README.md) - 아키텍처 결정 기록
- [PRD 목록](../prd/README.md) - 제품 요구사항
- [Learning 목록](../learning/README.md) - 학습 노트
